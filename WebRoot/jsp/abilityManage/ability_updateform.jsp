...
<html>
	...
	<body class="gray-bg" >
			...
			<form id="myform"  enctype="multipart/form-data">
				<div class="ibox-content col-sm-12">
					<div class="col-sm-12 form-group">
						<input type="hidden" id="abilityid" name="abilityid" value="${map.abilityid}" />
						<label class="date-label col-sm-2"><span style="color:red">*</span>&nbsp;能力编码</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" null="no" id="abilitycode" name="abilitycode" value="${map.abilitycode}" style="width:100%">
							<span class="errorspan">能力编码不能为空</span>
						</div>
						<label  class="date-label col-sm-2"><span style="color:red">*</span>&nbsp;能力名称</label>
						<div  class="col-sm-4">
							<input type="text" class="form-control" null="no" id="abilityname" name="abilityname" value="${map.abilityname}" style="width:100%">
					...
					<div class="col-sm-12 form-group">
						...
						<div  class="col-sm-10">
							<textarea class="form-control" null="yes" id="abilitymemo" name="abilitymemo" style="width:100%">${map.abilitymemo}</textarea>
						</div>
					</div>
					<div class="col-sm-12 form-group">
						<label  class="date-label col-sm-2">备注</label>
						<div  class="col-sm-10">
							<textarea class="form-control" null="yes" id="memo" name="memo" style="width:100%">${map.abilitymemo}</textarea>
						</div>
					</div>
					<div class="col-sm-12 form-group">
							...
							<span id="upload">
								<c:forEach items="${fjmap }" var="fj">
									<div style="font-size: 14px;padding: 10px;">
										<a href="../ability/downLoad.action?id=${fj.id}">${fj.sourcefile }</a><br/>
									</div>
								</c:forEach>
							</span>
						</div> 
		...
		$("#submitbtn").click(function(){
			...
			$.ajax({
				type: "post",
				url: "${pageContext.request.contextPath}/ability/abilityupdate.action",
				dataType: "json",
				data:datas,
				cache: false,
				processData: false,
