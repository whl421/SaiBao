	...
	<body class="gray-bg" >
			...
			<div class="ibox-content col-sm-12 col-xs-12">
				...
				<div class="col-sm-12 col-xs-12 ">
					<div class="form-group col-sm-12 col-xs-12">
						...
						<label  class="date-label col-sm-2 col-xs-2"></label>
						<div class="col-sm-4 col-xs-4">
				...
				<div class="col-sm-12 col-xs-12 ">
					<div class="form-group col-sm-12 col-xs-12">
						<label  class="date-label col-sm-2 col-xs-2 ">上一阶段移交</label>
						<div class="col-sm-10 col-xs-10">
				...
				<div class="col-sm-12 col-xs-12" >
					<div class=" form-group col-sm-12 col-xs-12 ">
						<label  class="date-label col-sm-2 col-xs-2"><span style="color:red">*</span>是否接收</label>
						<div class="col-sm-4 col-xs-4 ">
							<div class="form-control col-sm-8"  > 
							 <label class="radio-inline">
								<input type="radio"  value="2" name="bjdstate" id="bjdstate" checked >接收
							 </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 <label class="radio-inline">
								<input type="radio"  value="3" name="bjdstate" id="bjdstate" >拒绝
							 </label>	
							</div>
						</div>	
					</div>
				...
				<div class="col-sm-12 col-xs-12 ">
					<div class="form-group col-sm-12 col-xs-12">
						<label  class="date-label col-sm-2 col-xs-2 ">拒绝理由</label>
						<div class="col-sm-10 col-xs-10">
							<textarea rows="2" class="form-control" value="${map.rejectreason }"
								null="no" id="rejectreason" name="rejectreason" ></textarea>
						</div> 
					</div>
				</div>
		...
		<script type="text/javascript">
			...
			function setadd(aobj){
				...
				var prevlistid = "${map.prevlistid }";
				var rejectreason = $("#rejectreason").val();
				var bjdstate = $('input[name="bjdstate"]:checked').val();
				if(bjdstate == "3") {
				...
				parent.layer.load(2); 
				$.ajax({
					url : '${pageContext.request.contextPath}/taskCl/taskAccept.action?rundd='+new Date().getTime(),
					type : 'post',
					data : {tablejson:str},
					dataType : "json",
					async : false,
