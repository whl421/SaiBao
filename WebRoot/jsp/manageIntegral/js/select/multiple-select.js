...
//"<span><em style='font-style: normal;height: 10px;line-height: 10px;padding: 0px 3px;background: rgb(204, 204, 204);'								
				//list.push('<span><em class="cancel" value="' + $(this).val() + '">x</em> ' + $(this).parent().text() + '</span>' );
			   list.push($(elem).parent().text());
							 // var spans = document.createElement("span");
								// 		spans.innerHTML = $(elem).parent().text();
								// list.push(spans); 
              });
  ...
  var defaults = {
    ...
    textTemplate: function textTemplate($elm) {
		//	alert($elm[0].innerHTML);
			// var sd="<span><em style='font-style: normal;height: 10px;line-height: 10px;padding: 0px 3px;background: rgb(204, 204, 204);' value='"+$elm[0].value+"'>x</em>"+$elm[0].innerHTML+"</span>";
