...
<head>
    ...
    <link href="${pageContext.request.contextPath}/jsp/manageIntegral/css/style.css?v=4.1.0" rel="stylesheet">
	
	 <script src="${pageContext.request.contextPath}/jsp/manageIntegral/js/jquery.min.js?v=2.1.4"></script>
	 <!-- 部门人员选择树 -->
	 <script src="http://www.jq22.com/demo/bootstrap-treeview20161102/js/bootstrap-treeview.js"></script>
	 <script src="${pageContext.request.contextPath}/jsp/manageIntegral/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	 <script src="${pageContext.request.contextPath}/departuser/departuser.js"></script>
	 <link href="${pageContext.request.contextPath}/departuser/departuser.css" rel="stylesheet">
	...
	function Refreshtitleimg(){
		$("#titleimg").attr("src",'${pageContext.request.contextPath}/resources/cusid${user.cusid}/${user.userid}/titleimg.png?rt='+new Date().getTime());
	}
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" id="titleimg" class="img-circle titleimg" src="${pageContext.request.contextPath}/resources/cusid${user.cusid}/${user.userid}/titleimg.png" onerror="imgerrorfun();" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               	<span class="block m-t-xs">
	                               	<strong class="font-bold">${user.departname }</strong>&nbsp;&nbsp;
	                               	${user.username }<b class="caret"></b>
                               	</span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="${pageContext.request.contextPath}/login/changimgjsp.action">修改头像</a>
                                </li>
								<li><a href="JavaScript:PopupModalView(null,null,null,'修改信息>>密码修改','900px','80%','${pageContext.request.contextPath}/login/changepwdjsp.action');">修改密码</a>
								</li>
                                <li class="divider"></li>
...
<!-- 						</a> -->
				...
				<c:if test="${menuMap!=null}">	
                     <c:forEach items="${menuMap }" var="menu" >
                     	<li>
                     		<a class="${menu.class}" href="${menu.urlaction}">
							<i class="${menu.icon}"></i> 
							<span class="nav-label">${menu.htmlname}</span>
							<c:if test="${menu.list!=null}"><span class="fa arrow"></span></c:if>
							</a>
							<c:if test="${menu.list!=null}" >
								<ul class="nav nav-second-level">
					  	  	<c:forEach items="${menu.list }" var="menulist" >
					  	  		    <li>
					  	  		        <a class="J_menuItem" href="${menulist.urlaction}" ><i class="${menulist.icon}"></i> ${menulist.htmlname}</a>
					  	  		    </li>
							</c:forEach>
								</ul>
							</c:if>	
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" 
                    ...
                    <div class="navbar-header"   style="background:no-repeat url(${pageContext.request.contextPath}/jsp/manageIntegral/images/logo.png)">
						<a id="sbchange" class="navbar-minimalize minimalize-styl-2 btn btn-primary "  href="#"><i class="fa fa-bars"></i> </a>
            ...
            <div class="row content-tabs" >
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="organization.html">首页</a>
                    </div>
                </nav>
...
<!--                 <a href="login.html" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a> -->
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" id="index0" name="iframe0" width="100%" height="100%" src="${pageContext.request.contextPath}/report/indexreport.action" frameborder="0" data-id="organization.html" seamless></iframe>
            </div>
            <div class="footer">
...
<!--                             </div> -->
    ...
    <script src="${pageContext.request.contextPath}/jsp/manageIntegral/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${pageContext.request.contextPath}/jsp/manageIntegral/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${pageContext.request.contextPath}/jsp/manageIntegral/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="${pageContext.request.contextPath}/jsp/manageIntegral/js/hplus.js?v=4.1.0"></script>
	
    <script type="text/javascript" src="${pageContext.request.contextPath}/jsp/manageIntegral/js/contabs.js" ></script>
...
<script type="text/javascript">
	window.onload=function(){
		setTimeout(function(){
			if("${cstate}"=="1"){
				Ewin.alert({ message: "您的密码不安全，请修改！" });
			}
		},1000);
		if("${waitread.ggrd}"!="0"){
...
function DoCalcTime(){
		$.ajax({
			url:'${pageContext.request.contextPath}/login/caleWaitRead.action?rundd='+new Date().getTime(),
			type:'post',
			dataType:"json",
			async:true,
...
function CalcTime(){
	...
	if(document.getElementById("waitggrd")){
		var btime=document.getElementById("waitggrd").getAttribute("attr-time");
