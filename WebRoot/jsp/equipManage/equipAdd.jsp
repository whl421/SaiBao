...
<html>
	...
	<body class="gray-bg" >
			...
			<div class="ibox-content col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2 "><span style="color:red">*</span>设备编码</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.equipcode }"
								null="no" id="equipcode" name="equipcode" >
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2"><span style="color:red">*</span>设备名称</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2 ">所属部门</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<select  class="form-control col-xs-12 col-sm-12 col-md-12 col-lg-12" style="width:100%"
							 title="所属部门" 
						...
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">状态</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">设备描述</label>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
							<textarea  rows="2" class="form-control" 
							  id="equipdesc"  name="equipdesc" ></textarea >
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">备注</label>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
							<textarea  rows="2" class="form-control" 
		...
		function setadd(aobj){
			...
			var flag = "";
			flag = codeIsExist(equipcode,'');
			if(flag == "1") {
				$.ajax({
					url : '${pageContext.request.contextPath}/equip/save.action?rundd='+new Date().getTime(),
					type : 'post',
				 	data : {tablejson:str},
				    dataType : "json",
				    async : false,
