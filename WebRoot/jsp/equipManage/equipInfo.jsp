			...
			<div class="ibox-content col-sm-12">
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" value="${map.equipcode }" readonly="readonly"
								null="no" id="equipcode" name="equipcode" >
						</div> 
						<label  class="date-label col-sm-2"><span style="color:red">*</span>设备名称</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" value="${map.equipname }" readonly="readonly"
				...
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-4">
							<input type="text"  class="form-control" id="departname" name="departname" readonly="readonly" value="${map.departname}"/>
						</div> 
						<label  class="date-label col-sm-2">状态</label>
						<div class="col-sm-4 ">
							<c:if test="${map.estate == 1 }">
								<input type="text"  class="form-control" id="estate" name="estate" readonly="readonly" value="启用" />
							</c:if>
							<c:if test="${map.estate == 0 }">
								<input type="text"  class="form-control" id="estate" name="estate" readonly="readonly" value="禁用" />
							</c:if>	
							<c:if test="${map.estate == 2 }">
								<input type="text"  class="form-control" id="estate" name="estate" readonly="readonly" value="维护中" />
							</c:if>	
							<c:if test="${map.estate == 3 }">
								<input type="text"  class="form-control" id="estate" name="estate" readonly="readonly" value="维修中" />
							</c:if>	
						</div>	
					</div>
				</div>
					...
					<div class="btn-groups" style="text-align: center;">
						<div class="btn-group">
							<button onclick="giveup();"  class="btn btn-warning">
								<i class="glyphicon glyphicon-remove" aria-hidden="true"></i>返回
							</button>
						</div>
					</div>
				</div>	  
