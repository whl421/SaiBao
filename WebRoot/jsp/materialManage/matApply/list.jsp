...
<body class="gray-bg">
	<nav class="navigation" >
		...
		<span class="titlethis" >材料领用申请</span>
	</nav> 
						...
						<div class="form-inline">
							...
							<div class="form-group">
								...
								<select class="selectpicker form-control" data-done-button="true"
								   title=" 状态选择" id="applystate" name="tablesearch">
							...
							<div class="btn-groups hidden-xs" id="exampleToolbar" role="group">
								<c:if test="${button.add!=null}">
									<div id="add" class="btn-group">
										<a href="javascript:PopupModalView(null,'refresh','材料领用申请>>材料申请','60%','75%','${pageContext.request.contextPath}/matApply/addForm.action');"  class="btn btn-primary btn-sm">
											<i class="glyphicon glyphicon-plus" aria-hidden="true"></i>&nbsp;材料申请
										</a>
									</div>
								</c:if>
							</div>
	...
	<script type="text/javascript">
		...
		*/
		function infotable(index){
			var _url="${pageContext.request.contextPath}/matApply/infoForm.action?tablejson="+index;
		...
		*/
		function deletetable(index){
			var durl="${pageContext.request.contextPath}/matApply/delete.action";
			...
			function rowbutton(value,row,index){
				...
				if(applystate == "1") {
					if("${button.delete}"&&"${button.delete}"!=null&&"${button.delete}"!=""){
						bt1 += "<button type='button' onclick='deletetable("+row.clapplyid+")' class='btn btn-warning btn-sm'><i class='fa fa-trash'></i>删除</button>&nbsp;";
					}
				} 
				if(bt1 == "") {
					bt1 = "----";
