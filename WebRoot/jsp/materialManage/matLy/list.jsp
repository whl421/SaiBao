...
<body class="gray-bg">
	<nav class="navigation" >
		...
		<span class="titlethis" >材料领用查询</span>
	</nav> 
	...
	<script type="text/javascript">
		...
		*/
		function infotable(index){
			var _url="${pageContext.request.contextPath}/matLy/infoForm.action?tablejson="+index;
		...
		*/
		...
		$(function() {
			...
			$table= $('#exampleTablePagination').bootstrapTable({
				url: "${pageContext.request.contextPath}/matLy/list.action",
				//height: "650",			 //行高，如果没有设置height属性，
				uniqueId: "clapplylistid",          //每一行的唯一标识，一般为主键列
	...
	//              //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
			...
			// 设置隐藏列
			$table.bootstrapTable('hideColumn', 'clapplylistid');
