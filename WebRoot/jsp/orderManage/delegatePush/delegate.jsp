	...
	<body class="gray-bg" >
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox-content col-sm-12">
				...
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						<label  class="date-label col-sm-2"><span style="color:red">*</span>子中心</label>
						<div class="form-group col-sm-10">
							<select  class="form-control col-sm-12" style="width:100%"
							 title="子中心" 
							 null="no" id="departcode" name="manageIntegral" >
								<c:forEach items = "${deptList }" var = "dept">
								  <option value="${dept.departcode }">${dept.departname }</option>
								</c:forEach>
							</select>
						</div>
					</div>
