	...
	<body class="gray-bg" >
			...
			<div class="ibox-content col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">委托编号</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.ordercode }"
								null="no" id="ordercode" name="ordercode" readonly="readonly">
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">委托名称</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">委托时间</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.ordertime }"
								null="no" id="ordertime" name="ordertime" readonly="readonly">
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">委托人</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">金额</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.orderprice }"
								null="no" id="orderprice" name="orderprice" readonly="readonly">
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">报价日期</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.pricetime }"
								null="no" id="pricetime" name="pricetime" readonly="readonly">
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">客户名称</label>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">附件</label>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">确认说明</label>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
							<input type="text" class="form-control" value="${map.qrmemo }"
								null="no" id="qrmemo" name="qrmemo" readonly="readonly">
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">推送人</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.tsusername }"
								null="no" id="tsusername" name="tsusername" readonly="readonly">
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">推送日期</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.tsdate }"
								null="no" id="tsdate" name="tsdate" readonly="readonly">
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">子中心名</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.departname }"
								null="no" id="departname" name="departname" readonly="readonly">
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">子中心确认</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.liststate }"
								null="no" id="liststate" name="liststate" readonly="readonly">
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">子中心确认人</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.confirmuser }"
								null="no" id="confirmuser" name="confirmuser" readonly="readonly">
						</div> 
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">子中心确认日期</label>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<input type="text" class="form-control" value="${map.listdate }"
								null="no" id="listdate" name="listdate" readonly="readonly">
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label  class="date-label col-xs-2 col-sm-2 col-md-2 col-lg-2">子中心说明</label>
						<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
							<input type="text" class="form-control" value="${map.confirmmemo }"
								null="no" id="confirmmemo" name="confirmmemo" readonly="readonly">
						</div> 
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-inline buttonrow">
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 form-inline" style="text-align: center;">
						<!-- <div class="btn-group" >
		...
		<script type="text/javascript">
			...
			window.onload = function(){
				var liststate = "${map.liststate}";
				var liststateValue = "";
				if(liststate == "1") liststateValue = "待确认";
				if(liststate == "2") liststateValue = "接收";
				if(liststate == "3") liststateValue = "拒绝";
				$("#liststate").val(liststateValue);
			}
			//新增
			function setadd(aobj){
				...
				var obj = document.getElementById("departcode");
				...
				parent.layer.load(2); 
				$.ajax({
					url : '${pageContext.request.contextPath}/delegatePush/delegate.action?rundd='+new Date().getTime(),
					type : 'post',
					data : {tablejson:str},
					dataType : "json",
					async : false,
