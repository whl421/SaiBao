	...
	<body class="gray-bg" >
						...
						<div class="col-sm-4 ">
							<div class="form-control col-sm-8"  > 
							 <label class="radio-inline">
								<input type="radio"  value="2" name="liststate" id="liststate" checked >接收
							 </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 <label class="radio-inline">
								<input type="radio"  value="3" name="liststate" id="liststate" >拒绝
							 </label>	
							</div>
						</div>	
					</div>
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-10">
							<textarea  rows="2" class="form-control" 
							  id="confirmmemo"  name="manageIntegral" ></textarea >
						</div> 
					</div>
				</div>
		...
		<script type="text/javascript">
			...
			function setadd(aobj){
				...
				var liststate = $('input[name="liststate"]:checked').val();
				var data = {
					"orderId" : orderid,
					"liststate" : liststate,
				...
				parent.layer.load(2); 
				$.ajax({
					url : '${pageContext.request.contextPath}/orderAccept/accept.action?rundd='+new Date().getTime(),
					type : 'post',
					data : {tablejson:str},
					dataType : "json",
					async : false,
