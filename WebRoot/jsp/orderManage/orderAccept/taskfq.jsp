	...
	<body class="gray-bg" >
			...
			<div class="ibox-content col-sm-12">
				...
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						<label  class="date-label col-sm-2"><span style="color: red;">*</span>任务标题</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" 
								null="no" id="tasktitle" name="tasktitle" >
						</div> 
					</div>
				</div>
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						<label  class="date-label col-sm-2"><span style="color: red;">*</span>任务说明</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" 
								null="no" id="taskmemo" name="taskmemo" >
						</div> 
					</div>
				</div>
				<div class="col-sm-12 ">
				...
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						<label  class="date-label col-sm-2">第一个执行人</label>
						<div class="col-sm-10">
							<select  class="form-control col-sm-12" style="width:100%"
							 title="选择用户" 
							 null="no" id="executeuser" name="manageIntegral" >
								<option value=""></option>
		...
		<script type="text/javascript">
			...
			function setadd(aobj){
				...
				parent.layer.load(2); 
				$.ajax({
					url : '${pageContext.request.contextPath}/orderAccept/taskfq.action?rundd='+new Date().getTime(),
					type : 'post',
					data : {tablejson:str},
					dataType : "json",
					async : false,
