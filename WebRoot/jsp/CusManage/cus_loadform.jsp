		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<input type="hidden" id="cusid" name="manageIntegral" value="${map.cusid }" />
			  <div class="row col-sm-12 form-inline">
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;客户编号</label>
					<input type="text" class="form-control col-sm-8" value="${map.cuscode}" 
					 null="no" id="cuscode" name="manageIntegral" >
					<span class="errorspan">客户编号不能为空</span>
				</div>
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;会员等级</label>
					 <select  class="form-control col-sm-8 " null="no" id="hytype" name="manageIntegral">
					  	<option value=""></option>
					 ...
					 <span class="errorspan">会员等级不能为空</span>
				</div>
			  </div>
			
			 <div class="row col-sm-12 form-inline">
			 	<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;客户简称</label>
					<input type="text" class="form-control col-sm-8" value="${map.cusname}"
					 null="no" id="cusname" name="manageIntegral" > 
					 <span class="errorspan">客户简称不能为空</span>
				</div>
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;客户全称</label>
					<input type="text" class="form-control col-sm-8" value="${map.cusfullname}"
					 null="yes" id="cusfullname" name="manageIntegral">
					 <span class="errorspan">客户全称不能为空</span>
				</div>
			 </div>	  
			 <div class="row col-sm-12 form-inline">
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;管理员账号</label>
					<input type="text" class="form-control col-sm-8" value="${map.sysusername}" 
					 null="no" id="sysusername" name="manageIntegral" >
					 <span class="errorspan">管理员账号不能为空</span>
				</div>
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;购买金额</label>
					<input type="number" class="form-control col-sm-8" value="${map.money}"
					 null="no" id="money" name="manageIntegral">
					 <span class="errorspan">购买金额不能为空</span>
				</div>
			</div>	 
			<div class="row col-sm-12 form-inline">
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;购买日期</label>
					<input type="text" class="form-control col-sm-8" value="${map.startdate}"
					 null="no" id="startdate" name="manageIntegral">
					 <span class="errorspan">购买日期不能为空</span>
				</div>
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;到期日期</label>
					<input type="text" class="form-control col-sm-8" value="${map.dqdate}"
					 null="no" id="dqdate" name="manageIntegral">
					 <span class="errorspan">到期日期不能为空</span>
				</div>
			</div>	
			<div class="row col-sm-12 form-inline">
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;购买版本</label>
					<select  class="form-control col-sm-8 " null="no" id="version" name="manageIntegral">
					  	<option value=""></option>
					 ...
					 <span class="errorspan">购买版本不能为空</span>
				</div>
				<div class="form-group col-sm-6">
					<label  class="date-label col-sm-4"><span style="color:red">*</span>&nbsp;使用人数上限</label>
					<input type="number" class="form-control col-sm-8" value="${map.usernum}"
					 null="no" id="usernum" name="manageIntegral">
					 <span class="errorspan">使用人数上限不能为空</span>
				</div>
			</div> 
			<div class="row col-sm-12 form-inline">
				<div class="form-group col-sm-6">
			...
			<div class="row col-sm-12 form-inline">
				...
				<div class="form-group col-sm-6">
					...
					<input type="text" class="form-control col-sm-8" value="${map.xfdate}"
