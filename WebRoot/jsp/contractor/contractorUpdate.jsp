...
<html>
	...
	<body class="gray-bg" >
			...
			<div class="ibox-content col-sm-12">
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						<label  class="date-label col-sm-2 "><span style="color:red">*</span>分包商编码</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" value="${map.fbscode }"
								null="no" id="fbscode" name="fbscode" >
						</div> 
						<label  class="date-label col-sm-2"><span style="color:red">*</span>分包商名称</label>
						<div class="col-sm-4">
						...
						<div class="col-sm-4 ">
							<div class="form-control col-sm-12"  > 
							 <label class="radio-inline">
								<input type="radio"  value="1" name="fbsstate" id="fbsstate" <c:if test="${map.fbsstate == 1}">checked</c:if> >启用
							 </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 <label class="radio-inline">
								<input type="radio"  value="0" name="fbsstate" id="fbsstate" <c:if test="${map.fbsstate == 0}">checked</c:if> >禁用
							 </label>	
							</div>
						</div>	
					</div>
				...
				<div class="col-sm-12 ">
					<div class="form-group col-sm-12">
						<label  class="date-label col-sm-2">说明</label>
						<div class="col-sm-10">
		...
		function setadd(aobj){
			...
			var flag = "";
			flag = codeIsExist(fbscode,fbsid);
			if(flag == "1") {
				$.ajax({
					url : '${pageContext.request.contextPath}/contractor/update.action?rundd='+new Date().getTime(),
					type : 'post',
				 	data : {tablejson:str},
				    dataType : "json",
				    async : false,
